<template>
  <div class="flex p-8 pb-0 ">
    <input type="text" class="rounded border-2 border-gray-200 w-full" placeholder="Search by ingredient" v-model="keyword"
      @change="searchMeals" />
  </div>
...
function searchMeals() {
  store.dispatch('searchMealIngredient', keyword.value)
